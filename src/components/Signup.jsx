  ...
  return (
    <form action={formAction}>
      ...
      <div className="control">
        ...
        <select id="role" name="role" defaultValue={formState.enteredValues?.role} key={formState.enteredValues?.role}>
      ...
      <div className="control">
        <label htmlFor="terms-and-conditions">
          <input type="checkbox" id="terms-and-conditions" name="terms"
                 defaultChecked={formState.enteredValues?.terms === 'on'}/>I
...
function signupAction(prevFormState, formData) {
  ...
  if (!isNotEmpty(password) || !hasMinLength(password, 6)) {
    errors.push('You must provide a password with at least 6 characters long.');
  }
  ...
  if (!isNotEmpty(firstName) || !isNotEmpty(lastName)) {
    errors.push('Please provide both first name and last name.');
  }
  ...
  if (acquisitionChannel.length === 0) {
    errors.push('Please select a least one acquisition channel.');
  }
  if (errors.length > 0) {
    return {
      errors,
